                          ...
                          <Col className="text-center ml-auto mr-auto">
                            ...
                            <div>
                              <h4 class="card-title">
                                ...
                                {Number(props.location.state.verified) === 0 && (
                                  <Badge color="warning" className="py-1">
                                    Not yet Tested
                                  </Badge>
                                )}
                                {/* {console.log("verification in edit details ",props.location.state.verified)} */}
                                {Number(props.location.state.verified) === 1 && (
                                  <Badge color="success" className="py-1">
                                    Tested {"&"} Safe
                                  </Badge>
                                )}

                                {Number(props.location.state.verified) === 2 && (
