...
function LoginPage(props) {
  ...
  const [firstFocus, setFirstFocus] = useState(false);//change React.
  ...
  const populate_data = async (e) => {
    ...
    //     id: "0xA5Acb2A9a433330050557F63CF9e1D5dCc33Ada1",
    //     email: "bb1@gmail.com",
    //     pass: "1234",
    //     type: "1", // Blood bank
    ...
    //     id: "0xf788062BB0c2C799F9393d1cf625c7a66493FFbB",
    //     email: "bb2@gmail.com",
    //     pass: "1234",
    //     type: "1", // Blood bank
    ...
    //     id: "0xC5584fC8F492E16df46E281bD7eC3fFBbeA098b9",
    //     email: "bb3@gmail.com",
    //     pass: "1234",
    //     type: "1", // Blood bank
    ...
    try {
      await contract.methods
        .addidentity(
          ...
          '0xf47827e2fA8473935ef242789c5AB18B6083b441',
          'hsp@gmail.com',
          '1234',
          "0", //hospital
  ...
  const formSubmit = async (e) => {
    ...
    if (email_in.trim() !== "" && pass_in.trim() !== "") {
      try {
        var account_data = await contract.methods.getLogin(accounts[0], email_in.toString(), pass_in.toString()).call();
